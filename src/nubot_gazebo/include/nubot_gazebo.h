...
#include "nubot_common/Dribble.h"
...
namespace gazebo{
  ...
  class NubotGazebo : public ModelPlugin
  {
    private:
        ...
        ros::Publisher              gazebo_info_pub_;      /* four publishers cooresponding to those in world_model.cpp */
        ...
        nubot_common::GazeboInfo    gazebo_info_;
